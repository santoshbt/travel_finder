...
RSpec.describe AirlineSearch do
    describe 'it search for best matching' do
        ...
        it 'returns the best matching flight' do
            search_data = described_class.new(from_0, to_0, departure_date_0, airlines_data_0).search
        ...
        it 'returns the best and cheapest flight if there are more than one matching flights' do
            search_data = described_class.new(from_1, to_1, departure_date_1, airlines_data_1).search
        ...
        it 'returns no flights if no flight is matching' do
            search_data = described_class.new(from_2, to_2, departure_date_2, airlines_data_2).search
        ...
        it 'returns flights from any airport to destination airport, if from is `Any Airport` ' do
            search_data = described_class.new(from_3, to_3, departure_date_3, airlines_data_3).search
